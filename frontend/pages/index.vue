...
const fetchVideos = async () => {
  ...
  try {
    ...
    const url = isMature ? 'http://localhost:4000/api/videos?is18Plus=true' : 'http://localhost:4000/api/videos'
...
const fetchSubscriptions = async () => {
  ...
  try {
    const data = await $fetch('http://localhost:4000/api/users/subscriptions', {
